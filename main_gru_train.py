...
if __name__ == '__main__':
    ...
    model = GruBasedModel(n_steps_in=n_steps_in, n_features=n_features,
    ...
    history = model.fit(X_train,
                        ...
                        callbacks=[
                            # checkpoint_callback,
                            MultiOutputModelCheckpoint(filepath=cfg['saved_models']['gru_chkpoint_model'],
